...
for band in ['hi','lo']:
    for expt in ['3597','3598','3600','3601']:
        pathf=path0+band+'/3.+netcal/'+expt+'/hops_'+expt+'_3C279+netcal.uvfits'
        ...
        outname='SR1_3C279_2017_'+doy[expt]+'_'+band+'_hops_netcal_StokesI.uvfits'
        f0stokes.save_uvfits('./3C279_release/'+outname)
